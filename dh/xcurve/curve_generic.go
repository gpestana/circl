...
func (c *curve255) ladderStep(w *[5]fp255.Elt, b uint) {
...
func (c *curve255) mulA24(z, x *fp255.Elt) {
	const A24 = 121666
	const n = 8
	var xx [4]uint64
	for i := range xx {
...
func (c *curve255) double(x, z *fp255.Elt) {
...
func (c *curve255) difAdd(w *[5]fp255.Elt, b uint) {
...
func (c *curve448) ladderStep(w *[5]fp448.Elt, b uint) {
	x1, x2, z2, x3, z3 := &w[0], &w[1], &w[2], &w[3], &w[4]
	t0 := &fp448.Elt{}
	t1 := &fp448.Elt{}
	fp448.AddSub(x2, z2)
...
func (c *curve448) mulA24(z, x *fp448.Elt) {
	const A24 = 39082
	const n = 8
	var xx [7]uint64
	for i := range xx {
...
func (c *curve448) double(x, z *fp448.Elt) {
...
func (c *curve448) difAdd(w *[5]fp448.Elt, b uint) {
	mu, x1, z1, x2, z2 := &w[0], &w[1], &w[2], &w[3], &w[4]
	fp448.Cswap(x1, x2, b)
	fp448.Cswap(z1, z2, b)
	fp448.AddSub(x1, z1)
